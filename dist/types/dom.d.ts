export interface DuneDomElement extends Element {
    ...
    each(callback: (element: Element, index: number, parent: NodeListOf<Element> | Element[]) => void): void;
}
export interface DuneDom {
    ...
    setStyle(element: string | Element | NodeList | null | undefined, style: {
        [key: string]: string | number;
    }): void;
    insertHtml(element: string | Element | NodeList | null | undefined, html: string, position?: InsertPosition): void;
